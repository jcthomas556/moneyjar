            ...
            <td>
                <form action="Jars.php" method="GET">
                    <select onchange="this.form.submit()" id="jarSelector" name="jarSelector">
                        ...
                        ?>
                        <option value="<?php echo $holder['jar_total']; ?>"><?php echo $holder['jar_name']; echo $holder['jar_id']; ?></option>
                        
                            
                        <?php } $inviteCode=$holder['jar_invite_code']; $jar_total = $holder['jar_total']; $jarID= $holder['jar_id'];?> </select>
